...
public class Transfert implements Serializable {
    ...
    public String faireTransfert() {
        ...
        if (compteDestinataire == null) {
            ...
            // Message d'erreur associé au composant source ; form:destinataire est l'id client
            // si l'id du formulaire est "form" et l'id du champ de saisie de l'id du destinataire est "destinataire"
            // dans la page JSF qui lance le transfert.
            erreur = true;
        }
